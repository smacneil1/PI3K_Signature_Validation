...
```{r}
setwd("C:/Users/10002293/Desktop/ICBP_probabilities/ICBP_Oldsig")
...
typeof(probabilitied_300_dwdbild_icbp)
is.numeric(probabilitied_300_dwdbild_icbp)
is.numeric(probabilitied_300_dwdbild_icbp[,2])

class(probabilitied_300_dwdbild_icbp)
...
icbp_prob_matix <- cbind(probabilitied_300_dwdbild_icbp[2],probabilities_50_dwd_icbp[2],probabilities_100_dwd_icbp[2],probabilities_100_dwdbild_icbp[2],probabilities_100_quantile_icbp[2],probabilities_100_shiftscale_icbp[2],probabilities_200_dwd_icbp[2],probabilities_200_dwdbild_icbp[2],probabilities_300_dwd_icbp[2],probabilities_400_dwd_icbp[2],probabilities_50_dwdbild_icbp,probabilities_400_dwdbild_icbp[2],probabilities_500_dwd_icbp[2],probabilities_500_dwdbild_icbp[2]) 


class(icbp_prob_matix)
typeof(icbp_prob_matix)
View(icbp_prob_matix)
cor(icbp_prob_matix)
dim(icbp_prob_matix)
```
...
ICBP_RPPA_path=readFile("C:/Users/10002293/PI3K_Signature_Validation/filesharing/ICBP_proteomics.txt") 
ICBP_RPPA_path
...
probs_working= icbp_drug[,1:15]
probs=probs_working[,-11] 
...
write.table(drug_prob_corrs, "C:/Users/10002293/PI3K_Signature_Validation/filesharing/PI3K_Drug_Cors_ICBP_Oldsig.txt", col.names=NA,sep='\t',quote=F)
...
write.table(corrs_rppa, "C:/Users/10002293/PI3K_Signature_Validation/filesharing/PI3K_ICBP_RPPA_Cors_Oldsig.txt", col.names=NA,sep='\t',quote=F)
